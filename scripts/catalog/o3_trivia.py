...
GAMES = [
    ...
    dict(
        ...
        cfg=dict(mode='mapa', hud='bl', help='Se dice una capital de provincia (o, de vez en cuando, uno de los ocho ríos principales) y tienes que señalar dónde está en el mapa de España, dibujado sin nombres. En el móvil arrastra el dedo y suelta donde creas; con el teclado mueve el cursor con las flechas y confirma con Intro o espacio; en la tele mueve el joystick y pulsa A. Cuanto más cerca del sitio real, más puntos: menos de 35 km da la puntuación máxima. Ocho rondas, con Canarias en su recuadro; en los ríos puntúa la distancia al cauce. De 1 a 4 jugadores.'),
        ...
        desc=[
            ...
            'Las cincuenta capitales de provincia están tomadas de sus coordenadas reales y la lista se ordena por dificultad: las primeras rondas caen en capitales muy conocidas y las últimas en las que todo el mundo confunde. De vez en cuando la ronda pide un río en lugar de una ciudad, y entonces vale cualquier punto del cauce. En la tele cada móvil mueve su propia chincheta del color del jugador y nadie ve dónde apunta el resto hasta que se destapan todas; jugando solo te enfrentas a una CPU que comete errores de cientos de kilómetros al principio y que va afinando conforme le ganas partidas.',
        ],
