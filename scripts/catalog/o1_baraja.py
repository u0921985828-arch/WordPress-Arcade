...
GAMES = [
    dict(
        ...
        cfg=dict(mode='brisca', help='Elige carta con ← → y juega con A (o tócala). No hay que asistir. Valen As 11, Tres 10, Rey 4, Caballo 3 y Sota 2: gana la mano quien pase de 60 de 120. Regla opcional: el 7 de triunfo se cambia por la muestra si es alta y el 2 si es baja.'),
        desc=[
    ...
    dict(
        ...
        orient='auto', aspect='fill', inputs='TKMG', engine='baraja', pad=PAD, mp=(1, 4), players='1–4 jugadores',
        cfg=dict(mode='mus', help='Mus por parejas con 8 reyes (el 3 vale rey y el 2 as). Pide mus o corta; al descartar marca cartas y confirma con B. Lances: grande, chica, pares y juego (o punto). En cada lance: paso, envido, subir, quiero, no quiero u órdago. Partida a 40 piedras o corta a 20. Sin dinero.'),
        desc=[
    ...
    dict(
        ...
        orient='auto', aspect='fill', inputs='TKMG', engine='baraja', pad=PAD, mp=(1, 4), players='1–4 jugadores',
        cfg=dict(mode='chinchon', help='Roba del mazo o del descarte y tira una carta. Liga escaleras del mismo palo (el 7 va con la sota) y tríos o cuartetos. Cierra con 3 puntos sueltos o menos; las figuras valen 10. Todo ligado resta 10 y el chinchón (escalera de 7) gana la partida. A 100 puntos quedas eliminado.'),
        desc=[
