...
<body><script>window.CFG={cfg};</script><script src="../_lib/kit.js?v=21"></script>{deps}<script src="../_lib/{eng}.js?v={ev}"></script></body></html>
'''
...
def main():
    ...
    for slug, (eng, cfg) in G.items():
        ...
        dep[slug] = ['_lib/kit.js?v=21'] + [f'_lib/{d}.js?v=14' for d in deps_of(eng)] + [f'_lib/{eng}.js?v={ev}']
