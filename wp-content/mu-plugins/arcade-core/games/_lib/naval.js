...
const skill = () => clamp(0.245 + Math.min(9, LV + k.D.cpu) * 0.06 + (roundN - 1) * 0.03, 0.15, 0.85);   /* k.D.cpu: ±1 nivel de CPU sin tocar lo guardado */ /* 1.23: más fácil (antes 0,35 + 0,12/victoria, tope 0,98) */
