...
- Versión actual del plugin: **1.23.0** (`const VERSION` en `wp-content/mu-plugins/arcade-core.php`).
...
- **Marca Kubo** (`docs/brand/`): logo pixel art (cubo isométrico 2:1 + «kubo»), icono 31×31, favicon, banner 1200×630, story 1080×1920 y guía de marca; generados por script (rejilla exacta, escalado entero). Paleta: `#6e62f5 #a097ff #463ac4 #1a1530` + `#ff6fb5 #5b8cff #a8cf3f #ffc94d`. Aún no aplicada al portal. Dominio: el usuario baraja kubo.es / kuboplay.online.
