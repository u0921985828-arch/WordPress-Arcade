...
- Versión actual del plugin: **1.18.0** (`const VERSION` en `wp-content/mu-plugins/arcade-core.php`).
...
- Caché de motores: `?v=` = hash md5 del motor (automático en build_games.py); `kit.js` (v=9) y `art.js` (v=7) siguen con `?v=N` manual.
