...
- Versión actual del plugin: **1.20.0** (`const VERSION` en `wp-content/mu-plugins/arcade-core.php`).
...
- Caché de motores: `?v=` = hash md5 del motor (automático en build_games.py); `kit.js` (v=10) y `art.js` (v=9) siguen con `?v=N` manual.
