...
- Versión actual del plugin: **1.22.0** (`const VERSION` en `wp-content/mu-plugins/arcade-core.php`).
...
src/eng/*.js                   # FUENTE de los motores (62) de juego (+ art.js, librería de sprites)
scripts/
...
- Caché de motores: `?v=` = hash md5 del motor (automático en build_games.py); `kit.js` (v=12) y `art.js` (v=9) siguen con `?v=N` manual.
